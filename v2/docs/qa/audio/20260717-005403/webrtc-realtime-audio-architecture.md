...
- `IncrementalVoicePipeline` 已有 200 ms 软切句，适合保留：[/Users/sunshiqi/code/phdebate/v2/apps/api/app/services/realtime_voice.py](/Users/sunshiqi/code/phdebate/v2/apps/api/app/services/realtime_voice.py)
- MOSS 实时后端目前边读 PCM 边写 WAV，并在第一块 PCM 到达时发布 `audio.stream.started`：[/Users/sunshiqi/code/phdebate/v2/apps/api/app/services/providers.py](/Users/sunshiqi/code/phdebate/v2/apps/api/app/services/providers.py)
- 下行 WebSocket 每客户端读取同一增长文件，按 40 ms PCM 帧发送，应用层自己做 replay、flow control 和访问复核：[/Users/sunshiqi/code/phdebate/v2/apps/api/app/api/realtime.py](/Users/sunshiqi/code/phdebate/v2/apps/api/app/api/realtime.py)
- 浏览器为每个客户端维护 3 秒 ring buffer、400 ms 起播阈值和线性重采样：[/Users/sunshiqi/code/phdebate/v2/apps/web/lib/audio/pcm-stream-player.ts](/Users/sunshiqi/code/phdebate/v2/apps/web/lib/audio/pcm-stream-player.ts)、[/Users/sunshiqi/code/phdebate/v2/apps/web/public/worklets/pcm-ring-player.js](/Users/sunshiqi/code/phdebate/v2/apps/web/public/worklets/pcm-ring-player.js)
- 暂停、继续、提前结束、退出页面、放弃席位、结束发言后修改 ASR 文字已经有控制面，不需要因 WebRTC 重做：[/Users/sunshiqi/code/phdebate/v2/apps/api/app/api/rooms.py](/Users/sunshiqi/code/phdebate/v2/apps/api/app/api/rooms.py)、[/Users/sunshiqi/code/phdebate/v2/apps/web/components/debate-stage.tsx](/Users/sunshiqi/code/phdebate/v2/apps/web/components/debate-stage.tsx)
...
当前应用 Redis 为 `127.0.0.1:6380`、512 MB、`allkeys-lru`：[/Users/sunshiqi/code/phdebate/v2/deploy/redis-v2.conf](/Users/sunshiqi/code/phdebate/v2/deploy/redis-v2.conf)
