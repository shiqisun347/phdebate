...
| 项目 | 当前状态 | 判断 |
|---|---|---|
| `jixia-v2-api` | RUNNING | 正常 |
| `jixia-v2-engine` | RUNNING | 正常 |
| `jixia-v2-worker` | RUNNING | 正常 |
| `jixia-v2-web` | RUNNING | 正常 |
...
```bash
export PATH=/home/ubuntu/sunsq/phdebate-v2/runtime/node/bin:$PATH
