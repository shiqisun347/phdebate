...
- 执行时间（UTC）：2026-07-17T08:50:00.379725+00:00
- 语料版本：2026-07-17-v1
- Profile：smoke
- 音色：debate_voice_2
- 成功/请求：1/1
- 标准中文回转 CER 中位数 / P95：0.1892 / 0.1892
- 服务端完整 WAV 合成耗时 P50 / P95：8.003 s / 8.003 s
- RTF P50 / P95：0.781 / 0.781
- 样本 RMS 响度极差：0.0 dB
...
|---|---|---:|---:|---:|---:|---:|---|---:|---:|---:|---:|---:|---|---|
| NAMES_PUNCTUATION | debate_voice_2 | 46 | 2 | 8.003 | 10.250 | 0.781 | WAV/NONE/24000Hz/16bit/1ch | 384.0 | -16.69 | -1.62 | 300 | 18.9% | 陈思远说，前元明川宇之微，负责立论，井行若谷。剑山负责质询、驳论和总结。大家同意吗？ | FAIL: CER>10% |
