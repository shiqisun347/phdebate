...
- 快照分支：`backup/production-20260719-round5`
...
| 内容 | 文件 | SHA-256 |
| --- | --- | --- |
| V2 数据库 | `runtime/backups/auto-20260719T101354Z.dump` | `5a12a0d523ebb0d8d1273836677dfe8279ed9797ac669b65603fe5ab5b54c61a` |
| 比赛数据卷 | `20260719T101446Z-data-volumes.tar.gz` | `6196d28f0da0ffec304c6fc4c6fb1f12f963d8b6e3d68cbee780329f071f73ff` |
...
| Debate Agent 数据库 | `/home/ubuntu/sunsq/debate-agent/backups/agent-20260719T101355Z.dump` | `98f98874e8f9a6c08523d6d8fed774452a5887e730fb0b9da0a46b8fbdf81829` |
...
sha256sum -c auto-20260719T101354Z.dump.sha256

cd /home/ubuntu/sunsq/phdebate-v2/runtime/deploy-backups
sha256sum -c 20260719T101446Z-data-volumes.tar.gz.sha256
...
sha256sum -c agent-20260719T101355Z.dump.sha256
pg_restore -l agent-20260719T101355Z.dump >/dev/null
```
...
./deploy/verify-backup-restore.sh runtime/backups/auto-20260719T101354Z.dump
```
...
git clone --branch backup/production-20260719-round5 --single-branch \
...
runuser -u postgres -- pg_restore -p 5433 --exit-on-error \
  --no-owner --no-privileges -d phdebate_v2 auto-20260719T101354Z.dump

PGPASSWORD='从安全配置临时读取' pg_restore \
  -h 127.0.0.1 -p 5433 -U debate_agent --exit-on-error \
  --no-owner --no-privileges -d debate_agent agent-20260719T101355Z.dump
```
...
```bash
cd /home/ubuntu/sunsq/phdebate-v2
tar -xzf 20260719T101446Z-data-volumes.tar.gz
