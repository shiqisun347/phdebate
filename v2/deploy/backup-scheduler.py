...
ROOT = Path(os.environ.get("PHDEBATE_V2_ROOT", "/home/ubuntu/sunsq/phdebate-v2"))
BACKUP_DIR = Path(os.environ.get("PHDEBATE_V2_BACKUP_DIR", ROOT / "runtime/backups"))
...
logger = logging.getLogger("jixia-v2-backup")
