...
PYTHON_BIN="${PHDEBATE_V2_TEST_PYTHON:-$ROOT/.venv/bin/python}"
API_PORT="${PHDEBATE_V2_TEST_API_PORT:-18200}"
WEB_PORT="${PHDEBATE_V2_TEST_WEB_PORT:-13200}"
WORK_DIR="$(mktemp -d)"
...
WEB_PID=$!
wait_for_url "http://127.0.0.1:$WEB_PORT/v2/" "$WEB_LOG"

cd "$ROOT/apps/web"
E2E_BASE_URL="http://127.0.0.1:$WEB_PORT/v2/" \
E2E_MUTATING=true \
