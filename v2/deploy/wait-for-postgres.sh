...
PG_ISREADY="${PHDEBATE_V2_PG_ISREADY:-/usr/bin/pg_isready}"
HOST="${PHDEBATE_V2_POSTGRES_HOST:-127.0.0.1}"
PORT="${PHDEBATE_V2_POSTGRES_PORT:-5433}"
DATABASE="${PHDEBATE_V2_DATABASE:-phdebate_v2}"
INTERVAL_SECONDS="${PHDEBATE_V2_DATABASE_WAIT_INTERVAL_SECONDS:-2}"
TIMEOUT_SECONDS="${PHDEBATE_V2_DATABASE_WAIT_TIMEOUT_SECONDS:-0}"
