...
const labels: Record<string, string> = {
  ...
  "seat.ai_substituted": "AI 接替真人席位",
  "seat.restore_requested": "选手申请恢复真人席位",
  "seat.restore_cancelled": "选手撤销恢复申请",
  "seat.restore_rejected": "恢复申请暂未批准",
  "seat.restore_expired": "恢复申请已失效",
  "seat.human_restored": "恢复真人席位",
  "seat.control_acquired": "辩手设备取得控制权",
  "seat.control_taken_over": "辩手设备控制权已接管",
  "presence.connected": "辩手上线",
  "presence.disconnected": "辩手离线",
  "presence.expired": "断线保护到期",
