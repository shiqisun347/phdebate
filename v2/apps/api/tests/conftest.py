...
test_runtime = Path(tempfile.mkdtemp(prefix="phdebate-v2-pytest-"))
db_path = test_runtime / "pytest-v2.db"
...
os.environ["V2_ADMIN_ACCOUNT"] = "admin_test"
os.environ["V2_ADMIN_REAL_NAME"] = "测试管理员"
os.environ["V2_ADMIN_PASSWORD"] = "Admin-test-1234"
