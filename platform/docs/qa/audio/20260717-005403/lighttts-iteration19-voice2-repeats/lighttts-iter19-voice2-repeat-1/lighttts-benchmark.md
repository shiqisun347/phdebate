...
- 执行时间（UTC）：2026-07-17T08:49:38.950360+00:00
- 语料版本：2026-07-17-v1
- Profile：smoke
- 音色：debate_voice_2
- 成功/请求：1/1
- 标准中文回转 CER 中位数 / P95：0.2432 / 0.2432
- 服务端完整 WAV 合成耗时 P50 / P95：8.132 s / 8.132 s
- RTF P50 / P95：0.799 / 0.799
- 样本 RMS 响度极差：0.0 dB
...
|---|---|---:|---:|---:|---:|---:|---|---:|---:|---:|---:|---:|---|---|
| NAMES_PUNCTUATION | debate_voice_2 | 46 | 2 | 8.132 | 10.180 | 0.799 | WAV/NONE/24000Hz/16bit/1ch | 384.0 | -16.5 | -0.29 | 280 | 24.3% | 陈思远说，前元明川宇之危，负责立论，井行弱见山，负责质询驳论和总结。大家同意吗？ | FAIL: CER>10% |
