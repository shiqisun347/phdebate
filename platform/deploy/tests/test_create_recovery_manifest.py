...
def test_create_recovery_manifest_binds_code_and_private_artifacts(tmp_path: Path) -> None:
    ...
    files = {
        database_backups / "auto-20260720.dump": b"platform-db",
    ...
    env = {
        **os.environ,
        ...
        "PHDEBATE_DATABASE_BACKUP": str(database_backups / "auto-20260720.dump"),
    ...
    assert "artifact.platform_database.filename=auto-20260720.dump" in manifest
...
def test_verify_recovery_manifest_is_portable(tmp_path: Path) -> None:
    ...
    artifacts = {
        database_backups / "platform.dump": b"platform",
    ...
    env = {
        **os.environ,
        ...
        "PHDEBATE_RELIABLE_AUDIO_FINGERPRINT": "c" * 64,
        "PHDEBATE_DATABASE_BACKUP": str(database_backups / "platform.dump"),
