...
SESSION_COOKIE = "jixia_session"
CSRF_COOKIE = "jixia_csrf"
LEGACY_SESSION_COOKIE = "jixia_v2_session"
LEGACY_CSRF_COOKIE = "jixia_v2_csrf"
...
def request_csrf_cookie(request: Request) -> str | None:
    return request.cookies.get(CSRF_COOKIE) or request.cookies.get(LEGACY_CSRF_COOKIE)
...
def verify_csrf(
    ...
    if request.method in {"GET", "HEAD", "OPTIONS"}:
        return user
    session_token = request_session_token(request)
    csrf_cookie = request_csrf_cookie(request)
