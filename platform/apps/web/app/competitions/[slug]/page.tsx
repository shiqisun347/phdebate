  ...
  return (
    <div className="page-shell">
      ...
      <section style={{ paddingTop: 28 }}>
        ...
        {tab === "rules" && <article className="panel"><div className="panel-title"><h2>赛事规则</h2><ShieldCheck /></div><p className="hero-copy" style={{ whiteSpace: "pre-wrap", fontSize: 15 }}>{item.rules}</p><h3>通用约定</h3><ul className="muted" style={{ lineHeight: 2 }}><li>系统按固定阶段自动计时和切换。</li><li>只有当前轮次指定的人类辩手可以开启发言。</li><li>断线后保留席位 60 秒，超时由 AI 接替后续轮次。</li><li>每个房间最多允许 5 位观众同时在线；辩手、房主和管理员不占用观战名额。</li><li>禁止人身攻击、冒用身份和绕过客户端权限。</li></ul></article>}
        </div>
      </section>
