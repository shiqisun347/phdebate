      ...
      <section className="hero">
        ...
        <div className="hero-orbit" aria-hidden="true">
          <div className="hero-match-card">
            <div className="hero-match-kicker"><span className="status-dot online" />下一场公开赛</div>
            <div className="hero-match-topic">人工智能时代，还要不要学编程？</div>
            <div className="hero-match-sides">
              <div><span className="hero-side-dot aff" /><strong>正方</strong><small>4 个席位</small></div>
              <span className="hero-match-vs">VS</span>
              <div><span className="hero-side-dot neg" /><strong>反方</strong><small>4 个席位</small></div>
            </div>
            <div className="hero-match-footer"><span>自动赛程</span><span>AI 补位</span><span>实时观战</span></div>
          </div>
        </div>
      </section>
